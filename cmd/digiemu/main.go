...
func printUsage() {
	...
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  digiemu unit create [--key KEY] --title TITLE --desc DESC [--data ./data]")
...
func runUnit(args []string) {
	...
	case "create":
		...
		desc := fs.String("desc", "", "unit description")
		...
		in := ports.CreateUnitRequest{Key: k, Title: *title}
